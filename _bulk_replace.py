"""Bulk find/replace + page rename for Central Coast Tree Services.
...
REPLACEMENTS = [
    ("https://pakenhamdecking.com.au", "https://centralcoasttreeservice.com.au"),
    ("https://pakenhamdecking.netlify.app", "https://centralcoasttreeservice.netlify.app"),
    ("pakenhamdecking.netlify.app", "centralcoasttreeservice.netlify.app"),
    ("pakenhamdecking.com.au", "centralcoasttreeservice.com.au"),
    ("pakenhamdecking", "centralcoasttreeservice"),
    ("Pakenham Decking &amp; Pergolas", "Central Coast Tree Services"),
    ("Pakenham Decking & Pergolas", "Central Coast Tree Services"),
    ("/officer/", "/woy-woy/"),
    ("/beaconsfield/", "/erina/"),
    ("/cockatoo/", "/wyong/"),
    ("/emerald/", "/gosford/"),
    ("/pakenham-upper/", "/terrigal/"),
    ("/cardinia-shire/", "/central-coast-region/"),
    ("/services/timber-decking/", "/services/land-clearing/"),
    ("/services/composite-decking/", "/services/tree-removal/"),
    ("/services/pergolas/", "/services/stump-grinding/"),
    ("/services/alfresco-outdoor-kitchens/", "/services/tree-lopping/"),
    ("/services/deck-restoration/", "/services/emergency-tree-removal/"),
    ("VIC 3810", "NSW 2250"),
    ('"VIC"', '"NSW"'),
    ('"3810"', '"2250"'),
    ("Pakenham VIC 3810", "Central Coast NSW 2250"),
    ("3810", "2250"),
    ("-38.0814", "-33.4249"),
    ("145.4842", "151.3413"),
...
def main():
    ...
    for old, new in [
        ...
        ("cardinia-shire.astro", "central-coast-region.astro"),
    ]:
    ...
    if pkg.exists():
        ...
        s = s.replace('"name": "pakenhamdecking"', '"name": "centralcoasttreeservice"')
